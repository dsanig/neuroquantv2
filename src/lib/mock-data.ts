...
export const trades: Trade[] = [
  { id: 't1', date: '2026-03-10', symbol: 'SPY 240315C500', underlying: 'SPY', type: 'CALL', side: 'SELL', quantity: 10, price: 8.50, commission: 12.50, strategy: 'SPY Iron Condor', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  { id: 't2', date: '2026-03-10', symbol: 'SPY 240315P480', underlying: 'SPY', type: 'PUT', side: 'SELL', quantity: 10, price: 5.20, commission: 12.50, strategy: 'SPY Iron Condor', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  { id: 't3', date: '2026-03-10', symbol: 'SPY 240315C510', underlying: 'SPY', type: 'CALL', side: 'BUY', quantity: 10, price: 4.10, commission: 12.50, strategy: 'SPY Iron Condor', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  { id: 't4', date: '2026-03-08', symbol: 'AAPL', underlying: 'AAPL', type: 'STOCK', side: 'BUY', quantity: 500, price: 178.50, commission: 1.00, strategy: 'AAPL Covered Call', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  { id: 't5', date: '2026-03-08', symbol: 'AAPL 240419C185', underlying: 'AAPL', type: 'CALL', side: 'SELL', quantity: 5, price: 6.80, commission: 6.25, strategy: 'AAPL Covered Call', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  { id: 't6', date: '2026-03-07', symbol: 'QQQ 240517P400', underlying: 'QQQ', type: 'PUT', side: 'SELL', quantity: 8, price: 12.40, commission: 10.00, strategy: 'QQQ Put Spread', account: 'IBKR-Strat2', source: 'n8n-postgres', isRoll: false },
  { id: 't7', date: '2026-03-05', symbol: 'TSLA 240419C250', underlying: 'TSLA', type: 'CALL', side: 'SELL', quantity: 3, price: 15.60, commission: 3.75, strategy: 'TSLA Strangle', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: false },
  ...
  { id: 't9', date: '2026-03-03', symbol: 'SPY 240215C495', underlying: 'SPY', type: 'CALL', side: 'BUY', quantity: 10, price: 2.10, commission: 12.50, strategy: 'SPY Iron Condor', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: true },
  { id: 't10', date: '2026-03-03', symbol: 'SPY 240315C500', underlying: 'SPY', type: 'CALL', side: 'SELL', quantity: 10, price: 8.50, commission: 12.50, strategy: 'SPY Iron Condor', account: 'IBKR-Main', source: 'n8n-postgres', isRoll: true },
];

export const importBatches: ImportBatch[] = [
  { id: 'ib1', sourceId: 's1', sourceName: 'IBKR Daily Activity', fileName: 'U1234567_20260310_activity.csv.csv', parserProfile: 'IBKR Activity Statement', mappingVersion: 'v2.4', status: 'completed', importedRows: 847, errorRows: 3, totalRows: 850, startedAt: '2026-03-10T06:15:00Z', completedAt: '2026-03-10T06:16:42Z', triggeredBy: 'scheduler', errors: [{ row: 128, field: 'tradePrice', message: 'Invalid numeric format', value: 'N/A' }, { row: 445, field: 'expiry', message: 'Date parse error', value: '02/30/2026' }, { row: 712, field: 'quantity', message: 'Null not allowed', value: '' }] },
  { id: 'ib2', sourceId: 's1', sourceName: 'IBKR Daily Activity', fileName: 'U1234567_20260309_activity.csv.csv', parserProfile: 'IBKR Activity Statement', mappingVersion: 'v2.4', status: 'completed', importedRows: 623, errorRows: 0, totalRows: 623, startedAt: '2026-03-09T06:15:00Z', completedAt: '2026-03-09T06:16:18Z', triggeredBy: 'scheduler', errors: [] },
  { id: 'ib3', sourceId: 's1', sourceName: 'IBKR Daily Activity', fileName: 'U1234567_20260308_activity.csv.csv', parserProfile: 'IBKR Activity Statement', mappingVersion: 'v2.3', status: 'completed', importedRows: 1204, errorRows: 12, totalRows: 1216, startedAt: '2026-03-08T06:15:00Z', completedAt: '2026-03-08T06:18:05Z', triggeredBy: 'scheduler', errors: [{ row: 89, field: 'symbol', message: 'Unknown symbol format', value: 'SPX--260315C5000' }] },
  { id: 'ib4', sourceId: 's2', sourceName: 'IBKR Margin Report', fileName: 'U1234567_20260310_margin.xml.csv', parserProfile: 'IBKR Margin XML', mappingVersion: 'v1.1', status: 'failed', importedRows: 0, errorRows: 1, totalRows: 0, startedAt: '2026-03-10T06:20:00Z', triggeredBy: 'scheduler', errors: [{ row: 0, field: 'file', message: 'Data validation failed in pipeline', value: '' }] },
  { id: 'ib5', sourceId: 's1', sourceName: 'IBKR Daily Activity', fileName: 'U1234567_20260307_activity.csv.csv', parserProfile: 'IBKR Activity Statement', mappingVersion: 'v2.3', status: 'completed', importedRows: 492, errorRows: 1, totalRows: 493, startedAt: '2026-03-07T06:15:00Z', completedAt: '2026-03-07T06:16:02Z', triggeredBy: 'scheduler', errors: [] },
  { id: 'ib6', sourceId: 's1', sourceName: 'IBKR Daily Activity', fileName: 'U1234567_20260311_activity.csv.csv', parserProfile: 'IBKR Activity Statement', mappingVersion: 'v2.4', status: 'processing', importedRows: 320, errorRows: 0, totalRows: 750, startedAt: '2026-03-11T06:15:00Z', triggeredBy: 'scheduler', errors: [] },
];

export const dataSources: DataSource[] = [
  { id: 's1', name: 'IBKR Daily Activity', type: 'IBKR Activity Statement', protocol: 'PostgreSQL', host: '127.0.0.1', port: 22, username: 'U1234567', remotePath: '/outgoing/reports/', filenamePattern: 'U1234567_*_activity.csv.csv', pollingSchedule: '0 6 * * *', active: true, encrypted: true, lastConnected: '2026-03-11T06:15:00Z', lastStatus: 'connected' },
  { id: 's2', name: 'IBKR Margin Report', type: 'IBKR Margin Report', protocol: 'PostgreSQL', host: '127.0.0.1', port: 22, username: 'U1234567', remotePath: '/outgoing/reports/', filenamePattern: 'U1234567_*_margin.xml.csv', pollingSchedule: '0 6 * * *', active: true, encrypted: true, lastConnected: '2026-03-10T06:20:00Z', lastStatus: 'error', lastError: 'Pipeline data validation failed' },
  { id: 's3', name: 'IBKR Position Snapshot', type: 'IBKR Position File', protocol: 'PostgreSQL', host: '127.0.0.1', port: 22, username: 'U1234567', remotePath: '/outgoing/reports/', filenamePattern: 'U1234567_*_positions.csv.csv', pollingSchedule: '30 6 * * *', active: false, encrypted: true, lastStatus: 'unknown' },
];
...
export const auditLog: AuditEntry[] = [
  ...
  { id: 'a2', timestamp: '2026-03-11T06:15:00Z', actor: 'system', eventType: 'import.started', entityType: 'import_batch', entityId: 'ib6', source: 'scheduler', metadata: '{"file":"U1234567_20260311_activity.csv.csv"}' },
  ...
  { id: 'a4', timestamp: '2026-03-10T06:20:15Z', actor: 'system', eventType: 'import.failed', entityType: 'import_batch', entityId: 'ib4', source: 'scheduler', metadata: '{"error":"Pipeline data validation failed"}' },
